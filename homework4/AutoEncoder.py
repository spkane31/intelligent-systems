...
class Neural_Network(object):
    def __init__(self, inputSize, hiddenSize, outputSize, learningRate, epochs=500):#hiddenSize2, outputSize, learningRate):
        ...
        self.rhoHat = 0                         # Average Activation: This is just initally, has to be changed after a full pass through
    ...
    def initializeRhoHat(self, XTrain):
        ...
        a = self.sigmoid(z)
        rhohat = sum(sum(a))/self.hiddenSize
        self.rhoHat = rhohat
